...
const Slide:React.FC<propsType> = ({img,title,mainTitle,price}) => {
  return (
    <div className='outline-none border-none relative w-full h-[500px]'>
        ...
        sm:rounded-none">
            ...
            <h3 className='text-[24px] text-gray-500'> 
              starting at {" "}
              <b className='md:text-[24px] text-[20px] lg:text-[30px]'>{price}</b>
            .00</h3>
        ...
        ' src={img} alt='banner' width={1000} height={2000}/>
    </div>
  )
}
